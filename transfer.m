a = im2double(imread('C:\Users\Thanuja.A\OneDrive\Pictures\Screenshots\OIP.jpg')); % Input Texture
b = im2double(imread('C:\Users\Thanuja.A\OneDrive\Pictures\Screenshots\OIP (1).jpg')); % Input Image
